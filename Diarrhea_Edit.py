...
gui=Tk()
gui.title("DIARRHEDIT")
gui.geometry("600x500")
text=Text(gui)
text.pack()
mymenu=Menu()
list1=Menu()
list1.add_command(label='New file :O',command=new_file)
list1.add_command(label='Open file :)',command=open_file)
list1.add_command(label='save B)',command=save_file)
list1.add_command(label='Save As :D',command=save_as)
